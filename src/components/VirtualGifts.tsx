...
const gifts: GiftBox[] = [
  ...
  },
  {
    ...
    message:
      "May you continue to grow into the amazing person you're meant to be!",
  },
];
...
export default function VirtualGifts({ onContinue }: VirtualGiftsProps) {
  ...
  const handleGiftClick = (gift: GiftBox) => {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="font-serif text-lg md:text-xl text-[#8B7355] mb-4">
            Click on each gift to reveal your surprise! 🎁
          </p>
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border-2 border-[#E8D4BA] mb-8">
              ...
              <p className="text-[#8B7355]">
                These are all my heartfelt wishes and genuine thoughts for you.</p>
            </div>
